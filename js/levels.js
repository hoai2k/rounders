...
//
//                 NO LIPS. A tower's top must be reachable by the climb itself:
//                 never cap a column with a wider plate, because the overhang
//                 becomes a ceiling the climber bonks into instead of a perch
//                 they land on. Make the tower one rectangle whose own top is
//                 the perch (widen the tower if you want a roomier perch), or
//                 step it like a pyramid — each tier no wider than the one
//                 below. Where a shape genuinely needs an overhang (a torii
//                 beam, a ledge on props), leave the OUTER face flush so there
//                 is still one clean way up.
  ...
  const LEVELS = [
    ...
    },
    {
      ...
      platforms: [
        ...
        P(780, 800, 220, 22, { breakable: 100 }),
        P(1000, 800, 220, 22, { breakable: 100 }),
    ...
    },
    {
      ...
      platforms: [
        ...
        P(60, 540, 140, 22, { breakable: 120 }), P(1400, 540, 140, 22, { breakable: 120 }),
        P(660, 260, 280, 24)
      ],
      movers: [
    ...
    },
    {
      ...
      platforms: [
        ...
        P(1050, 560, 140, 22),
        P(360, 440, 220, 24), P(1020, 440, 220, 24)
      ],
    ...
    },
    {
      ...
      platforms: [
        ...
        P(500, 506, 600, 26),
        P(156, 655, 280, 26), P(1164, 655, 280, 26)
    ...
    },
    {
      ...
      platforms: [
        P(0, 830, 1600, 70),
        P(150, 650, 286, 24, { conveyor: -160 }),
        P(1164, 650, 286, 24, { conveyor: 160 }),
        P(710, 516, 180, 314),
    ...
    },
    {
      ...
      platforms: [
        ...
        P(64, 636, 120, 284),
        P(1576, 636, 120, 284),
        P(248, 740, 280, 26, { phase: { period: 4.6, offset: 0, duty: 0.65 } }),
        P(1232, 740, 280, 26, { phase: { period: 4.6, offset: 2.3, duty: 0.65 } }),
        P(700, 670, 360, 26)
      ],
    ...
    },
    {
      ...
      hung: [{ x: 940, y: 490, w: 200, h: 26, chains: [990, 1090] }],
      crates: [
    ...
    },
    {
      ...
      platforms: [
        ...
        P(760, 680, 150, 22, { breakable: 100 })
      ],
    ...
    },
    {
      ...
      platforms: [
        ...
        P(620, 430, 360, 26),
        P(240, 430, 100, 130), P(1260, 430, 100, 130),
    ...
    },
    {
      ...
      platforms: [
        ...
        P(300, 564, 60, 196), P(1240, 564, 60, 196),
        P(640, 420, 320, 24),
    ...
    },
    {
      ...
      hung: [
        ...
        { x: 854, y: 330, w: 130, h: 20, chains: [875] }
      ],
    ...
    },
    {
      ...
      platforms: [
        ...
        P(1266, 456, 114, 244),
        P(620, 600, 360, 28),
        P(398, 440, 220, 24, { phase: { period: 5.5, offset: 0, duty: 0.7 } }),
        P(982, 440, 220, 24, { phase: { period: 5.5, offset: 2.75, duty: 0.7 } }),
        P(680, 280, 240, 24),
      ...
      spawns: [{ x: 200, y: 660 }, { x: 1400, y: 660 }, { x: 420, y: 660 }, { x: 1180, y: 660 }]
    }
  ];
